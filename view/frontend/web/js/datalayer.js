...
define([
     ...
     * the customer and the cart. It should have the following structure:
    ...
    /**
     * The modified tracking initialization. 
     * 
     * @todo The local variables "isExternalGTM" and "strict"
     * are defined in this function but should come as
     * function parameter... 
     * 
    ...
    function initTracking(dataLayerName, accountId, containerCode, isExternal)
    {
        ...
        isExternalGTM
            ...
            // initialize the trackung the default way, by generating it
     ...
     * initialization check should be strict or not. If set to true, the function will only consider
     * the tracking as initialized if the dataLayer object exists and has a length greater than 0. If
     * set to false, the function will consider
     */
